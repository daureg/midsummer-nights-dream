...
\begin{marginfigure}
  ...
  \caption[Cross edge representation]{In that graphs, there are four possible edges between the two
...
\begin{proof}
  ...
  loops over its edges argument. During the for loop of line 4, we only perform constant time
  operations on maps. Likewise, in the for loop of line 9, the most expensive is finding the minimum
