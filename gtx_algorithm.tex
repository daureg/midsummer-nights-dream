...
\marginpars{Actually, we only need to assume that $G_0$ is connected because then we can prove that
the other subsequent $G_t$ will be as well.}
...
they are presented later on~\vpageref{ssec:gtx_center_choice}.} This is achieved efficiently by
