...
\usepackage{mdframed}
\newenvironment{aside}%
{\begin{mdframed}[hidealllines=true, leftline=true, innertopmargin=0.1ex, innerbottommargin=0.1ex,
      innermargin=2.3em, leftmargin=2.3em, outermargin=0em, innerleftmargin=0.7em, innerrightmargin=0pt,
      linewidth=2.0pt, skipabove=\baselineskip, skipbelow=\baselineskip, linecolor=Gray]\small}%
{\end{mdframed}}
