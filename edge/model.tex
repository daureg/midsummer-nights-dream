...
A further simplification is that while \eqref{eq:edge_soft_early} requires to optimize
...
At this stage, we could also add the node loss term \eqref{eq:edge_node_loss}, expressed in matricial
form as $\|X - B -
